...
import { removeFromWatchlist, addToFavorites, removeFromFavorites } from '../store/CineSlice'
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                {sortedWatchlist.length === 0 ? (
                    <div className={`text-center py-16 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                        ...
                        <p className="mb-6">Start adding movies and TV shows you want to watch!</p>
                        <Link 
                            to="/" 
